...
L'application client est une interface graphique permettant à
...
Le concept du portail applicatif est de fournir l'environnement
d'installation et d'utilisation \footnote{Donner l'exemple des
  application PAE} des applications générées à partir de
notre générateur. Il représente le moule qui donne au développeur, un
apperçu d'à quoi va ressembler son application à l'installation. 

L'interface du  portail applicatif se décline dans la figure suivante.
Elle est subdivisée en 6 parties à savoir :

\begin{itemize}
\item 1- Cette partie indique le nom du module installé
\item 2- 
\item 3- {\tt Menus}, il s'agit de la liste des menus du module
\item 4- {\tt Linked modules}, liste des modules liés au module
  installé \footnote{expliquer la liaison de module}
\item 5- {\tt Workspace}, 
\item 2-
...
en place d'une architecture (MVC). Ils permettent de définir les
...
les processus métiers et ressources permettant d'interagir avec le client.
...
REST. Ceci se décline dans l'interface de la figure suivante.  Elle
